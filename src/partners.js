 ...
 *   ceo      대표이사 (선택)
 *   field    주요사업분야 (선택)
 *   intro    회사 비즈니스 설명 (선택) — 인터넷/RAG 검색 정보를 논리적으로 정리하되
 *            글자수 200자 내외로 제한하고, 반드시 완결된 문장(…입니다./…합니다.)으로 끝낼 것
 *   address  주소 (선택)
 *   phone    연락처 (선택)
...
const PARTNERS = [
  {
    ...
    ceo: "이동은",
    field: "창의수학, 한글교육 전문",
    intro: "(주)DS두뇌로세계로는 유아·초등 대상 창의영재수학 브랜드 「DS두뇌로창의영재수학(K-MATH)」을 운영하는 교육기업입니다. NumberLand·BrainMath 프로그램과 가정연계 온라인 콘텐츠로 아이들의 사고력·창의력·문제해결력을 키웁니다. 도시공동체본부의 지역 아동·청소년 교육과 마을 교육복지 사업에 창의수학 콘텐츠로 협력할 수 있습니다.",
