...
[사람들]
- 이사장: 이가희 문학박사 (2025년 3월 취임). 도시공동체본부를 대표하는 이사회 의장입니다. 인사말에서 “지역이 스스로 회복하는 힘을 설계하고, 그 체계를 지역에 남기겠다”는 방향을 밝혔습니다.
- 상임대표: 이형구 박사 (소설가·2026년 신춘문예 당선. 현 노아벤처스 대표파트너, 전 세종테크노파크 디지털융합센터장, 전 세종창조경제혁신센터 본부장 등. 2026년 1월 선임).
...
[조직]
거버넌스는 이사장(이가희 문학박사) → 상임대표(이형구 박사) → 사무국과 6대 사업부문으로 구성됩니다. 임원 13명, 이사회·자문위원회(학계·산업·공공·법률)를 운영합니다.
6대 사업부문: 지속가능도시연구소, 교육혁신센터, 컨설팅센터, 치유산업센터, 미디어협력센터, 이벤트사업부.
...
const CARDS = [
  ...
  { keys: ["이가희", "이사장", "의장", "이사장님", "대표자", "누가대표"],
    text: "이사장은 이가희 문학박사입니다(2025년 3월 취임). 도시공동체본부를 대표하는 이사회 의장으로, ‘지역이 스스로 회복하는 힘을 설계하고 그 체계를 지역에 남긴다’는 방향을 이끌고 있습니다. 실무를 총괄하는 상임대표는 이형구 박사입니다. 자세한 인사말은 [인사말](/about/greeting) 페이지에서 볼 수 있습니다." },
  { keys: ["이형구", "상임대표", "대표", "소설가"],
    text: "상임대표는 이형구 박사입니다(2026년 1월 선임). 소설가로 2026년 신춘문예에 당선되었고, 현재 노아벤처스 대표파트너이며 전 세종테크노파크 디지털융합센터장·세종창조경제혁신센터 본부장 등을 지냈습니다. 이사회를 대표하는 이사장은 이가희 문학박사입니다." },
  { keys: ["사람들", "임원", "이사", "이사회", "누가", "구성원", "임원진"],
    text: "이사장은 이가희 문학박사, 상임대표는 이형구 박사입니다. 이사회는 윤중경·이재일·손호철·김은현·방만기·박기택·이항선·김들풀·임병철 등 도시·건축·사회적경제·ESG·바이오·SW·법률 등 다양한 분야의 전문가로 구성되며, 자문위원으로 고동록·정용환 등이 참여합니다. 자세한 명단은 [함께하는 사람들](/members/board) 페이지에서 볼 수 있습니다." },
  { keys: ["조직", "조직도", "거버넌스", "센터", "사업부문", "부서", "6대", "연구소"],
    text: "거버넌스는 이사장(이가희 문학박사) → 상임대표(이형구 박사) → 사무국과 6대 사업부문으로 구성됩니다. 6대 부문은 지속가능도시연구소·교육혁신센터·컨설팅센터·치유산업센터·미디어협력센터·이벤트사업부입니다. 자세한 내용은 [조직도](/about/org)에서 볼 수 있습니다." },
